...
\renewcommand{\date}[1]{\textsc{{\addfontfeature{VerticalPosition=Denominator}(}#1{\addfontfeature{VerticalPosition=Denominator})}}}
...
\rhead{\textsc{paul d.~gessler—\thepage{} of \pageref*{LastPage}}} \cfoot{}
\thispagestyle{empty}
...
\begin{itemize*}
  \item Cumulative GPA: 3.50/4.00; \href{http://www.marquette.edu/engineering/mechanical/grad_study.shtml}{Energy Systems Specialization}
...
HTML/CSS,
\LaTeX{},
\href{http://www.ctan.org/pkg/pgf}{Ti\emph{k}z/PGF},
\href{http://www.ctan.org/pkg/pgfplots}{\textsc{pgfplots}},
Vim, 
Git SCM,
Arch Linux, 
Mac OS X, 
...
\begin{itemize*}
  ...
  \item Improved chiller model execution speed by implementing native property functions% and enhanced stall 
...
\bigskip
\mhead{Professional \newline Affiliations}%
Member \TeX{} Users Group (TUG) \rdate{2013–2014}\newline
